...
import com.springapi.easyshop.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<Resource> downloadImage(@PathVariable Long imageId) throws SQLException {
        ...
        ByteArrayResource resource = new ByteArrayResource(imageBlob.getBytes(1, (int) image.getImage().length()));
